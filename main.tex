...
\section{Classificazione}
   ...
   \newpage
    \begin{enumerate}
    \subsection{Multinomial Naive Bayes Classification}
    \begin{justify}
...
\section{Ottimizzazione modelli}\label{ott}
    \begin{justify}
        ...
        \centering
        \includegraphics[width=0.70\linewidth]{pics/classificationReport_LinearSVC_best.png}
        ...
        \begin{figure}[H]
        \includegraphics[width=0.80\linewidth]{pics/key_des_best.PNG}
        \captionsetup{width=0.80\textwidth, justification=centering}
        \caption{Top 10 keywords più frequenti contenute nelle descrizioni degli elementi di ogni cluster}
        \end{figure}

        \begin{figure}[H]
        \includegraphics[width=0.80\linewidth]{pics/key_aut_best.PNG}
        \captionsetup{width=0.80\textwidth, justification=centering}
        \caption{Top 10 autori più frequenti contenuti negli elementi\\ di ogni cluster}
        \end{figure}
